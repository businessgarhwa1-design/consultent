...
export interface ConsultantDetails {
  ...
  firm_name: string;
  designation: string; // e.g. "Chartered Accountant", "GST Practitioner", "Tax Consultant"
  registration_no: string; // e.g. Membership / Enrollment No
  gstin?: string;
  pan?: string;
  email: string;
  mobile: string;
